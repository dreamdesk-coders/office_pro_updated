...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/opening/opening_sale_handler.php" class="frm_ p-4">
                    <h4>Opening Sale</h4>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <input type="button" value="Cancel"
                        onclick="window.location.href ='<?php echo $common_form_route."?frm=opening_sale_list" ?>'"
