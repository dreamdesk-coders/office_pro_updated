...
if (strlen($_SESSION['alogin'])==0) {
    ...
    if(isset($_GET['id'])){
        ...
        // header('location:$common_form_route?frm=sale_return__list');
    }
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/sale_return/sale_return_handler.php" class="frm_">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="grand_total" name="grand_total"
                                    value="<?php echo htmlentities($grand_total_amount) ?>" onchange="sum_amounts()"
                                    min="0" step="<?php echo htmlentities($step_string); ?>" readonly required>
                            </div>
                    ...
                    <button type="submit" name="update" class="btn btn-primary">Update Sale Return</button>
                    <input type="button" value="Cancel"
                        onclick="window.location.href ='<?php echo $common_form_route."?frm=sale_return_list" ?>'"
                        class="btn btn-secondary">

                    <a href="handler/sale/sale_return/sale_return_handler.php?delete=1&invoice_id=<?php echo $invoice_id ?>"
