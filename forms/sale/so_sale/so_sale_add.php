...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/sale/sale_handler.php" class="frm_">
                    <h4>Sale</h4>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoice_id" name="invoice_id" onchange="check_id_exist('sale','invoice_id',this.id)" required>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="customer_id" name="customer_id"
                                    value="<?php echo htmlentities($customer_id); ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="<?php echo htmlentities('quantity' . $num) ?>"
                                                    ...
                                                    min="0" readonly onchange="sum_amounts()">
                                            </td>
                                            <td>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="tax" name="tax" onchange="sum_amounts()"
                                    min="0" step="<?php echo htmlentities($step_string); ?>" value="0" required>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="grand_total" name="grand_total"
                                    value="<?php echo htmlentities($total_amount) ?>" onchange="sum_amounts()" min="0"
                    ...
                    <button type="submit" name="save" class="btn btn-primary">Save Sale</button>
