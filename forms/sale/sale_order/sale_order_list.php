...
if($role == "Management Admin"){
	$sql = "Select * From sale_order where status = 'Active' order by order_date desc";
	$query = $dbh -> prepare($sql);
}
else{
	$office_id = $_SESSION['office_id'];
	$sql = "Select * From sale_order where status = 'Active' and office_id =:office_id order by order_date desc";
	$query = $dbh -> prepare($sql);
...
<div class="main-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
                  <a href="<?php echo $common_form_route."?frm=sale_order_add" ?>" class="btn btn-primary">Add New Sale Order</a>
				<br><br>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12" style="background-color: #fff;">
				<br>
				<h4>Sale Order Transactions</h4>
				<br>
				<div class="res-table">
				<table class="table table-striped" id="sale-order-table">
				  <thead>
				    <tr>
				      <td scope="col">No</td>
				  ...
				  <tbody>
					...
					<tr>
						...
						<td><a href="<?php echo $common_form_route."?frm=sale_order_update&id=".$order_id ?>" class="btn btn-info">View</a></td>
					</tr>
