...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('sale_order')">Excel Export</button>


    </div>

    <div class="voucher" id="sale_order">
        <div class="page-header">
            ...
            <h5 class="title">Sale Order Voucher</h5><br>
            <hr>
            <div class="heading-2">
