            ...
            <div class="col-md-12">
                <form class="frm_">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="order_date" name="cancel_date"
                                    value="<?php echo htmlentities($order_date);?>" required readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="price<?php echo $num ?>"
                                                    ...
                                                    onchange="sum_amounts()" readonly readonly>
                                            </td>
                                            <td>
                    ...
                    <input type="button" value="Invoice Print"
                        onclick="window.open('<?php echo $common_form_route ?>?frm=sale_order_cancel_voucher&id=<?php echo $order_id ?>');"
                    ...
                    <a href="<?php echo $common_form_route ?>?frm=sale_order_cancel_list"
