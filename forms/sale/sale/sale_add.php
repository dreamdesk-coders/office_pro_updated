        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/sale/sale_handler.php" class="frm_ p-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoice_id" name="invoice_id"
                                    onchange="check_id_exist('sale','invoice_id',this.id)" required>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="discount" name="discount" value="0"
                                    onchange="discount_percent_();sum_amounts();" min="0"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="discount_percent" name="discount_percent"
                                    value="0" onchange="discount_();sum_amounts()" min="0" max="100"
                                    step="<?php echo htmlentities($step_string); ?>" required>
                            </div>
                        </div>
                    ...
                    <input type="submit" name="save" id="save" value="Save Sale" onclick="sum_amounts()"
