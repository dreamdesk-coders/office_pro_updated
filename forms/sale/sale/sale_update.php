...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/sale/sale_handler.php" class="frm_ p-4">
                    <h4>Sale</h4>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="res-table">
                                <table class="table table-striped" id="_table" onchange="uncheck();"
                                    onclick="uncheck();" onkeydown="uncheck();" onkeypress="uncheck();" onkeyup="uncheck();">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                    ...
                                    $sql = "Select * From sale_details where invoice_id=:invoice_id ";
                                    $query = $dbh -> prepare($sql);
                                    $query->bindParam(':invoice_id',$invoice_id,PDO::PARAM_STR);
                                    $query->execute();
                                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group mb-3">
                                                    <input type="text" value="<?php echo $unit_id ?>"
                                                        ...
                                                        onchange="check_child_su(this.id);get_stock_price(this.id, 'S');reset_qty_on_unit_change(this.id);sum_amounts();"
                                            ...
                                            <td>
                                                <input type="number" id="<?php echo htmlentities('quantity'.$num) ?>"
                                                    ...
                                                    min="0"
                                                    onchange="sum_amounts(),get_stock_balance(this.id,'<?php echo $invoice_id; ?>')"
                                                    required>
                                            </td>
                                            <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <?php if($sale_type == "Advance"){ ?>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="advance" name="advance" checked>
                                <label class="form-check-label" for="advance">Advance Sale</label>
                            </div>
                            <?php }else{?>
                            <div class="form-check">
                    ...
                    <button type="submit" name="update" id="save" class="btn btn-primary">Update Sale</button>
                    <input type="button" value="Cancel"
                        onclick="window.location.href ='<?php echo $common_form_route."?frm=sale_list" ?>'"
                        class="btn btn-secondary">

                    <a href="handler/sale/sale/sale_handler.php?delete=1&invoice_id=<?php echo $invoice_id ?>"
