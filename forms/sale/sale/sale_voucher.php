...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('sale')">Excel Export</button>
    </div>

    <table id="sale" class="voucher">
        <!-- Start Header -->
        <thead>
            <tr>
                <td>
                    ...
                    <br>
                    <h5 class="title">Sale Voucher</h5>
                    <hr><br>
                    <!-- <br><br><br> -->
                ...
                <table class="print-content table">
                    ...
                    <tbody>
                        ...
                        <tr style="line-height: 2.5;">
                            ...
                            <td colspan="3"><b>Type : <?php echo $sale_type ?></b></td>
