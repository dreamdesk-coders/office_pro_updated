                ...
                <form method="POST" action="handler/sale/delivery/delivery_handler.php" class="frm_">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoice_id" name="invoice_id"
                                    onchange="check_id_exist('delivery','invoice_id',this.id)" required>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label for="net_amount">Grand Total</label>
                                <input type="number" class="form-control" id="grand_total" name="grand_total" value="<?php echo htmlentities($total_amount); ?>"
                                    onchange="sum_amounts()" min="0" step="<?php echo htmlentities($step_string); ?>"
                                    readonly required>
                            </div>
                    ...
                    <button type="submit" name="save" class="btn btn-primary">Save Delivery</button>
