...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/delivery_order/delivery_order_handler.php" class="frm_">
                    ...
                    <button type="button" class="btn btn-primary"
                        onclick="window.open('<?php echo $common_form_route ?>?frm=delivery_order_voucher&id=<?php echo $order_id ?>')">Invoice
                        Print</button>
                    <button type="button" name="" class="btn btn-primary disabled"
                        style="pointer-events: none;cursor: not-allowed;" disabled>Update Delivery Order</button>
                    <?php } else { ?>
                    ...
                    <button type="submit" name="update" id="save" class="btn btn-primary">Update Delivery Order</button>
                    <?php } ?>


                    <input type="button" value="Cancel"
                        onclick="window.location.href ='<?php echo $common_form_route . "?frm=delivery_order_list" ?>'"
                    ...
                    <a href="<?php echo $common_form_route ?>?frm=do_delivery_update&id=<?php echo $invoice_id ?>"
                    ...
                    <a href="handler/sale/delivery_order/delivery_order_handler.php?cancel=1&order_id=<?php echo $order_id ?>"
                        class="btn btn-primary">Cancel This Order</a>

                    <a href="<?php echo $common_form_route ?>?frm=do_delivery_add&id=<?php echo $order_id ?>"
