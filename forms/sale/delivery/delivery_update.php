        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/sale/delivery/delivery_handler.php" class="frm_">
                                            ...
                                            <td>
                                                <div class="input-group mb-3">
                                                    <input type="text" value="<?php echo $unit_id ?>"
                                                        ...
                                                        onchange="check_child_su(this.id);reset_qty_on_unit_change(this.id);sum_amounts();" class="form-control"
                                                        required>
                                                    <div class="input-group-append">
                                                        <input type="button"
                                                            class="btn btn-outline-secondary lookup-btn"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="net_amount" name="net_amount"
                                    onchange="sum_amounts()" min="0" step="<?php echo htmlentities($step_string); ?>"
                                    value="<?php echo htmlentities($net_amount) ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" name="update" id="save" class="btn btn-primary">Update Delivery Sale</button>
