...
if($role == "Management Admin"){
	$sql = "Select * From purchase_order where status = 'Inactive' order by order_date desc";
	$query = $dbh -> prepare($sql);

}
else{
	$office_id = $_SESSION['office_id'];
	$sql = "Select * From purchase_order where status = 'Inactive' and office_id =:office_id order by order_date desc";
	$query = $dbh -> prepare($sql);
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" style="background-color: #fff;">
				<br>
				<h4>Purchase Order Cancel Transactions</h4>
				<br>
				<div class="res-table">
				<table class="table table-striped" id="purchase-order-cancel-table">
				  <thead>
				    <tr>
				      <td scope="col">No</td>
				  ...
				  <tbody>
					...
					<tr>
						...
						<td><a href="<?php echo $common_form_route."?frm=purchase_order_cancel_view&id=".$order_id ?>" class="btn btn-info">View</a></td>
					</tr>
