                ...
                <form class="frm_">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="cancel_date">Order Cancel Date</label>
                    ...
                    <input type="button" value="Invoice Print"
                        onclick="window.open('<?php echo $common_form_route ?>?frm=purchase_order_cancel_voucher&id=<?php echo $order_id ?>');"
                        class="btn btn-primary">
                    <a href="handler/purchase/purchase_order/purchase_order_handler.php?delete=1&order_id=<?php echo $order_id ?>"
                        class="btn btn-danger">Delete Transaction</a>
                    <a href="<?php echo $common_form_route ?>?frm=purchase_order_cancel_list"
