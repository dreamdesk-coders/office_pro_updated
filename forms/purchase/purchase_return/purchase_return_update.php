...
if (strlen($_SESSION['alogin'])==0) {
    ...
    if(isset($_GET['id'])){
        ...
        $sql = "Select * From purchase_return WHERE invoice_id=:invoice_id";
...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/purchase/purchase_return/purchase_return_handler.php" class="frm_">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="supplier_id" name="supplier_id"
                                    ...
                                    value="<?php echo htmlentities($supplier_id);?>" required>
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary lookup-btn" type="button"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="res-table">
                                <table class="table table-striped" id="_table">
                                    ...
                                    $sql = "Select * From purchase_return_details where invoice_id=:invoice_id ";
                                    $query = $dbh -> prepare($sql);
                                    $query->bindParam(':invoice_id',$invoice_id,PDO::PARAM_STR);
                                    $query->execute();
                                            ...
                                            <td>
                                                <div class="input-group mb-3">
                                                    <input type="text" value="<?php echo $unit_id ?>"
                                                        ...
                                                        onchange="check_child_su(this.id);get_stock_price(this.id, 'P');reset_qty_on_unit_change(this.id);sum_amounts();"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label for="expense">Refund Amount</label>
                                <input type="number" class="form-control" id="refund_amount" name="refund_amount"
                                    onchange="sum_amounts()" min="0" step="<?php echo htmlentities($step_string); ?>"
                                    value="<?php echo htmlentities($refund_amount) ?>" required>
                            </div>
                            <div class="form-group">
                    ...
                    <button type="submit" name="update" class="btn btn-primary">Update Purchase Return</button>
                    <input type="button" value="Cancel"
                        onclick="window.location.href ='<?php echo $common_form_route."?frm=purchase_return_list" ?>'"
                        class="btn btn-secondary">

                    <a href="handler/purchase/purchase_return/purchase_return_handler.php?delete=1&invoice_id=<?php echo $invoice_id ?>"
