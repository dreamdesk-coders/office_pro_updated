...
<div class="nav-bar no-print">
    ...
    <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('purchase_return')">Excel
        Export</button>


</div>

<div class="voucher" id="purchase_return">
    <div class="page-header">
        ...
        <h5 class="title">Purchase Return Voucher</h5><br>
        <hr>
        <div class="heading-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 head">
                        <table class="top-data">
                            ...
                            <tr>
                                <th>
                                    <p style="width:135px;">Exchange Rate</p>
                                </th>
                                <td>
