...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['id'])) {
        $order_id = $_GET['id'];
        $order_id = rawurldecode($order_id);
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="handler/purchase/purchase_order/purchase_order_handler.php" class="frm_">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="order_id" name="order_id" value="<?php echo htmlentities($order_id); ?>" readonly required>
                                </div>

                                <div class="form-group">
                                    <label for="order_date">Date</label>
                                    <input type="date" class="form-control" id="order_date" name="order_date" value="<?php echo htmlentities($order_date); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="supplier_id" name="supplier_id" onchange="check_data_exist('supplier','supplier_id',$('#supplier_id').val(), this.id,'lbl_supplier_id')" value="<?php echo htmlentities($supplier_id); ?>" required>
                                    <div class="input-group-append">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" id="<?php echo htmlentities('quantity' . $num) ?>" name="quantity<?php echo $num ?>" value="<?php echo htmlentities($quantity); ?>" class="form-control" min="0" onchange="sum_amounts()">
                                                    </td>
                                                    <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="tax" name="tax" onchange="sum_amounts()" min="0" step="<?php echo htmlentities($step_string); ?>" value="<?php echo htmlentities($tax) ?>" required>
                                </div>
                        ...
                        <?php
                        $sql = "Select * From purchase WHERE order_id=:order_id";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':order_id', $order_id, PDO::PARAM_STR);
                        $query->execute();
                        ...
                        if ($count > 0) {
                        ?>
                            <button type="button" class="btn btn-primary" onclick="window.open('<?php echo $common_form_route ?>?frm=purchase_order_voucher&id=<?php echo $order_id ?>')">Invoice Print</button>
                            <button type="button" name="" class="btn btn-primary disabled" style="pointer-events: none;cursor: not-allowed;" disabled>Update Purchase Order</button>
                        <?php } else { ?>
                            ...
                            <button type="submit" name="update" class="btn btn-primary">Update Purchase Order</button>
                        <?php } ?>
                        ...
                        ?>
                            ...
                            <a href="#" class="btn btn-danger disabled" style="pointer-events: none;cursor: not-allowed;" disabled>Delete Transaction</a>

                            <a href="#" class="btn btn-primary disabled" style="pointer-events: none;cursor: not-allowed;" disabled>Cancel This Order</a>

                            <a href="<?php echo $common_form_route ?>?frm=po_purchase_update&id=<?php echo $invoice_id ?>" class="btn btn-primary">Purchased</a>

                        <?php } else { ?>

                            <a href="handler/purchase/purchase_order/purchase_order_handler.php?delete=1&order_id=<?php echo $order_id ?>" class="btn btn-danger">Delete Transaction</a>

                            <a href="handler/purchase/purchase_order/purchase_order_handler.php?cancel=1&order_id=<?php echo $order_id ?>" class="btn btn-primary">Cancel This Order</a>

                            <a href="<?php echo $common_form_route ?>?frm=po_purchase_add&id=<?php echo $order_id ?>" class="btn btn-primary">Purchase</a>
