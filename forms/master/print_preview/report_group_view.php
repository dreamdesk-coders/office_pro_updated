...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From report_group WHERE rg_id between :f_id and :t_id order by rg_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('report_group_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="report_group_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Report Group List Preview</h5><br>
        </div>
