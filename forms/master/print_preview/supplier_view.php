...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From supplier WHERE supplier_id between :f_id and :t_id order by supplier_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('supplier_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="supplier_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Supplier List Preview</h5><br>
        </div>
