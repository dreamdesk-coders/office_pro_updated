...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From stock WHERE stock_id between :f_id and :t_id order by stock_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('stock_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="stock_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Stock List Preview</h5><br>
        </div>
                                ...
                                <table class="table" style="width: 94%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Stocking Unit ID</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($result->stock_name); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->stocking_unit_id); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->category_id); ?>
                                                </td>
                                                <td>
                                                    <?php echo htmlentities($result->rg_id); ?>
                                                </td>
