...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From currency WHERE currency_id between :f_id and :t_id order by currency_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('currency_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="currency_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Currency List Preview</h5><br>
        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo htmlentities($result->currency_name); ?>
                                                </td>
