...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From units_of_measurement WHERE unit_id between :f_id and :t_id order by unit_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('units_of_measurement_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="units_of_measurement_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Units Of Measurement List Preview</h5><br>
        </div>
