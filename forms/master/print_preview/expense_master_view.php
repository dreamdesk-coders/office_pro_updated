...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_id']) && isset($_GET['t_id'])) {
        ...
        $sql = "Select * From expense_master WHERE expense_id between :f_id and :t_id order by expense_id asc";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('expense_master_pp')">Excel Export</button>


    </div>

    <div class="voucher" id="expense_master_pp">
        <div class="page-header">
            ...
            <h5 class="title" style="margin-top:25px">Expense Master List Preview</h5><br>
        </div>
