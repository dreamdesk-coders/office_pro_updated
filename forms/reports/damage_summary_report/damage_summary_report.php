...
?>
    <script type="text/javascript" src="assets/js/reports/damage_summary_report/damage_summary_report.js"></script>
                ...
                <div class="col-md-6">
                    <div class="row bg-white report">
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_f_damage_id">From Damage ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_damage_id" name="f_damage_id" onchange="check_data_exist('damage','damage_id',$('#f_damage_id').val(), this.id,'l_f_damage_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_damage_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_t_damage_id">To Damage ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_damage_id" name="t_damage_id" onchange="check_data_exist('damage','damage_id',$('#t_damage_id').val(), this.id,'l_t_damage_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_damage_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
