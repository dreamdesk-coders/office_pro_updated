...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['f_office_id']) && isset($_GET['t_office_id'])) {
        $f_date = $_GET['f_date'];
        $t_date = $_GET['t_date'];
        $f_damage_id = $_GET['f_damage_id'];
        $t_damage_id = $_GET['t_damage_id'];
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('damage_summary_report')">Excel Export</button>
    </div>

    <table id="damage_summary_report" class="voucher">
        <tr>
            <td>
                <div class="heading">
                ...
                <br>
                <h5 class="title">Damage Summary Report</h5>
                <hr><br>

                <?php


                $sql3 = "Select damage_date,$group_by,sum(total_amount) as grand_total_amount From stock_damage where damage_date between :f_date and :t_date and damage_id between :f_damage_id and :t_damage_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id  group by damage_date,$group_by order by damage_date asc";

                $query3 = $dbh->prepare($sql3);

                $query3->bindParam(':f_date', $f_date, PDO::PARAM_STR);
                $query3->bindParam(':t_date', $t_date, PDO::PARAM_STR);
                $query3->bindParam(':f_damage_id', $f_damage_id, PDO::PARAM_STR);
                $query3->bindParam(':t_damage_id', $t_damage_id, PDO::PARAM_STR);
                ...
                ?>
                        ...
                        <table class="print-content table table-bordered">
                            <h6 class="groupby">
                                ...
                                <b> Damage Date : <?php $date = date_create($result3->damage_date);
                                ...
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th style="width: 100px;">Damage ID</th>
                                ...
                                <tbody>
                                    ...
                                    $sql = "Select * From stock_damage where damage_date between :f_date and :t_date and damage_id between :f_damage_id and :t_damage_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and damage_date = :group_damage_date and currency_id = :group_currency_id order by damage_date asc";

                                    $query = $dbh->prepare($sql);

                                    $query->bindParam(':f_date', $f_date, PDO::PARAM_STR);
                                    $query->bindParam(':t_date', $t_date, PDO::PARAM_STR);
                                    $query->bindParam(':f_damage_id', $f_damage_id, PDO::PARAM_STR);
                                    $query->bindParam(':t_damage_id', $t_damage_id, PDO::PARAM_STR);
                                    ...
                                    $query->bindParam(':group_damage_date', $result3->damage_date, PDO::PARAM_STR);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo htmlentities($result->damage_id); ?>
                                            </td>
                                            <td>
                                                <?php $date = date_create($result->damage_date);
                                                echo date_format($date, "d/m/Y"); ?>
                                            </td>
                                            <td>
