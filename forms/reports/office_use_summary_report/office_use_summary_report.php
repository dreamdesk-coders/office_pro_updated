...
?>
    <script type="text/javascript" src="assets/js/reports/office_use_summary_report/office_use_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Office Use Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_f_use_id">From Office Use ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_use_id" name="f_use_id" onchange="check_data_exist('office_use','use_id',$('#f_use_id').val(), this.id,'l_f_use_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_use_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_t_use_id">To Office Use ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_use_id" name="t_use_id" onchange="check_data_exist('office_use','use_id',$('#t_use_id').val(), this.id,'l_t_use_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_use_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
