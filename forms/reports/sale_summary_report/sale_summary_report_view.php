    ...
    <table id="sale_summary_report" class="voucher">
        <tr>
            <td>
                ...
                if ($sale_type == "all") {
                    $sql3 = "Select invoice_date,$group_by,sum(net_amount) as net_total_amount , sum(grand_total_amount) as grand_total_amount From $transaction_type where invoice_date between :f_date and :t_date and invoice_id between :f_invoice_id and :t_invoice_id and customer_id between :f_customer_id and :t_customer_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id  group by invoice_date,$group_by order by invoice_date asc";
                } else {
                    $sql3 = "Select invoice_date,$group_by,sum(net_amount) as net_total_amount,sum(grand_total_amount) as grand_total_amount From $transaction_type where invoice_date between :f_date and :t_date and invoice_id between :f_invoice_id and :t_invoice_id and customer_id between :f_customer_id and :t_customer_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and $transaction_type_t = :sale_type group by invoice_date,$group_by order by invoice_date asc";
                }
                            ...
                            <h6 class="groupby">
                                ...
                                <tbody>
                                    ...
                                    if ($sale_type == "all") {
                                        ...
                                        $sql = "Select * From $transaction_type where invoice_date between :f_date and :t_date and invoice_id between :f_invoice_id and :t_invoice_id and customer_id between :f_customer_id and :t_customer_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and invoice_date = :group_invoice_date and $group_by = :group_by_id and $transaction_type_t = :sale_type order by invoice_date asc";
                                    }
