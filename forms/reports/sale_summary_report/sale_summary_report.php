...
?>
    <script type="text/javascript" src="assets/js/reports/sale_summary_report/sale_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Sale & Delivery Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_sale_invoice">
                            <form>
                                <label for="l_f_invoice_id">From Invoice ID (Sale)</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_invoice_id" name="f_invoice_id" onchange="check_data_exist('sale','invoice_id',$('#f_invoice_id').val(), this.id,'l_f_invoice_id')" required>
                        ...
                        <div class="col-md-6 ft_sale_invoice">
                            <form>
                                <label for="l_t_invoice_id">To Invoice ID (Sale)</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_invoice_id" name="t_invoice_id" onchange="check_data_exist('sale','invoice_id',$('#t_invoice_id').val(), this.id,'l_t_invoice_id')" required>
                                    <div class="input-group-append">
                        ...
                        <div class="col-md-6 ft_delivery_invoice">
                            <form>
                                <label for="l_f_delivery_invoice_id">From Invoice ID (Delivery)</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_delivery_invoice_id" name="f_delivery_invoice_id" onchange="check_data_exist('delivery','invoice_id',$('#f_invoice_id').val(), this.id,'l_f_invoice_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_delivery_invoice_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_delivery_invoice">
                            <form>
                                <label for="l_t_delivery_invoice_id">To Invoice ID (Delivery)</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_delivery_invoice_id" name="t_delivery_invoice_id" onchange="check_data_exist('delivery','invoice_id',$('#t_invoice_id').val(), this.id,'l_t_invoice_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_delivery_invoice_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row bg-white report report-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="ttradio" value="all" id="tt_all" checked>All
                                </label>
                            </div><br>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="ttradio" value="sale" id="tt_sale">Sale
                                </label>
                            </div><br>
