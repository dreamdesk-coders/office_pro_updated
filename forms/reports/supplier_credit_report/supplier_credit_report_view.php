...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('supplier_credit_report')">Excel Export</button>
    </div>

    <table id="supplier_credit_report" class="voucher">
        <tr>
            <td>
                <div class="heading">
                ...
                <br>
                <h5 class="title">Supplier Credit Report</h5>
                <hr><br>
                ...
                if ($purchase_type == "all") {
                    $sql3 = "Select invoice_date,$group_by,sum(net_amount) as net_total_amount,sum(grand_total_amount) From purchase where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id  group by invoice_date,$group_by order by invoice_date asc";
                } else {
                    $sql3 = "Select invoice_date,$group_by,sum(net_amount) as net_total_amount,sum(grand_total_amount)  From purchase where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and purchase_type = :purchase_type group by invoice_date,$group_by order by invoice_date asc";
                }
                            ...
                            <h6 class="groupby">
                                ...
                                <tbody>
                                    ...
                                    if ($purchase_type == "all") {
                                        ...
                                        $sql = "Select * From purchase where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and invoice_date = :group_invoice_date and $group_by = :group_by_id and purchase_type = :purchase_type order by invoice_date asc";
                                    }
                                    ...
                                    <tr>
                                        <td style="text-align:center" colspan="10"><b>Total Suplier Credit Amount</b></td>
                                        <td style="text-align:right" colspan="8"><b>
