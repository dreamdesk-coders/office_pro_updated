...
?>
    <script type="text/javascript" src="assets/js/reports/cash_balance_report/cash_balance_report.js"></script>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" value="currency" id="gb_currency" checked>Currency
                                </label>
                            </div><br>
                        </div>
                    </div>
