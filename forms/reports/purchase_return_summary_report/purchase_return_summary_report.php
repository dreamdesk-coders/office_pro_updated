...
?>
    <script type="text/javascript" src="assets/js/reports/purchase_return_summary_report/purchase_return_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Purchase Return Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_invoice_id" name="f_invoice_id" onchange="check_data_exist('purchase_return','invoice_id',$('#f_invoice_id').val(), this.id,'l_f_invoice_id')" required>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_invoice_id" name="t_invoice_id" onchange="check_data_exist('purchase_return','invoice_id',$('#t_invoice_id').val(), this.id,'l_t_invoice_id')" required>
                                    <div class="input-group-append">
