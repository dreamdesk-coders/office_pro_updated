...
?>
    <script type="text/javascript" src="assets/js/reports/top_purchase_report/top_purchase_report.js"></script>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" value="supplier" id="gb_supplier" checked>Supplier ID
                                </label>
                            </div><br>
                            <div class="form-check">
                                <label class="form-check-label">
