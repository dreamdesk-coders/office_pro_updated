...
?>
    <script type="text/javascript" src="assets/js/reports/top_sale_report/top_sale_report.js"></script>
                ...
                <div class="col-md-6">
                    <div class="row bg-white report report-left">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" value="currency" id="gb_currency">Currency ID
                                </label>
                            </div> -->
                        </div>
                    </div><br>
