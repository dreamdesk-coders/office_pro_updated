    ...
    <table id="top_sale_report" class="voucher">
        <tr>
            <td>
                ...
                if ($sale_type == "all") {
                    $sql3 = "Select $group_by,sum(grand_total_amount) as grand_total_amount From $transaction_type where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and office_id between :f_office_id and :t_office_id  group by $group_by order by  grand_total_amount desc limit $limit";
                } else {
                    $sql3 = "Select $group_by,sum(grand_total_amount) as grand_total_amount From $transaction_type where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and office_id between :f_office_id and :t_office_id and $transaction_type_t = :sale_type  group by $group_by order by grand_total_amount desc limit $limit";
                }
                        ...
                        <table class="print-content table table-bordered">
                            <h6 class="groupby">
                                ...
                                <tbody>
                                    ...
                                    if ($sale_type == "all") {
                                        $sql = "Select * From $transaction_type where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and office_id between :f_office_id and :t_office_id and $group_by = :group_by_id order by grand_total_amount desc";
                                    } else {
                                        $sql = "Select * From $transaction_type where invoice_date between :f_date and :t_date and currency_id between :f_currency_id and :t_currency_id and office_id between :f_office_id and :t_office_id and $transaction_type_t = :sale_type and $group_by = :group_by_id order by grand_total_amount desc";
                                    }
                                    $query = $dbh->prepare($sql);
