...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('sale_return_summary_report')">Excel Export</button>
    </div>

    <table id="sale_return_summary_report" class="voucher">
        <tr>
            <td>
                <div class="heading">
                ...
                ?>
                        ...
                        <table class="print-content table table-bordered">
                            <h6 class="groupby">
                                ...
                                <b> Order Date : <?php $date = date_create($result3->invoice_date);
