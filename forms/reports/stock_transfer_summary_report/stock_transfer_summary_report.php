...
?>
    <script type="text/javascript" src="assets/js/reports/stock_transfer_summary_report/stock_transfer_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Stock Transfer Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_f_transfer_id">From Transfer ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_transfer_id" name="f_transfer_id" onchange="check_data_exist('stock_transfer','transfer_id',$('#f_transfer_id').val(), this.id,'l_f_transfer_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_transfer_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_t_transfer_id">To Transfer ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_transfer_id" name="t_transfer_id" onchange="check_data_exist('stock_transfer','transfer_id',$('#t_transfer_id').val(), this.id,'l_t_transfer_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_transfer_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
