...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('delivery_order_summary_report')">Excel Export</button>
    </div>

    <table id="delivery_order_summary_report" class="voucher">
        <tr>
            <td>
                <div class="heading">
                ...
                <br>
                <h5 class="title">Delivery Order Summary Report</h5>
                <hr><br>

                <?php


                $sql3 = "Select order_date,$group_by,sum(total_amount) as grand_total_amount From delivery_order where order_date between :f_date and :t_date and order_id between :f_order_id and :t_order_id and customer_id between :f_customer_id and :t_customer_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id  and status = 'active' group by order_date,$group_by order by order_date asc";
                ...
                ?>
                        ...
                        <table class="print-content table table-bordered">
                            <h6 class="groupby">
                                ...
                                <b> Order Date : <?php $date = date_create($result3->order_date);
                                ...
                                <tbody>
                                    ...
                                    $sql = "Select * From delivery_order where order_date between :f_date and :t_date and order_id between :f_order_id and :t_order_id and customer_id between :f_customer_id and :t_customer_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and status = 'active' and order_date = :group_order_date and $group_by = :group_by_id order by order_date asc";
                                    ...
                                    $query->bindParam(':group_order_date', $result3->order_date, PDO::PARAM_STR);
