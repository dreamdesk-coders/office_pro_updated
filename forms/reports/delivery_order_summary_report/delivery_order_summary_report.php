...
?>
    <script type="text/javascript" src="assets/js/reports/delivery_order_summary_report/delivery_order_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Delivery Order Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
