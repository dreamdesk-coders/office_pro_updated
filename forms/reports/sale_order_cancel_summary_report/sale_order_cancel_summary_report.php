...
?>
    <script type="text/javascript" src="assets/js/reports/sale_order_cancel_summary_report/sale_order_cancel_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Sale Order Cancel Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_order_id" name="f_order_id" onchange="check_data_exist('sale_order','order_id',$('#f_order_id').val(), this.id,'l_f_order_id')" required>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_order_id" name="t_order_id" onchange="check_data_exist('sale_order','order_id',$('#t_order_id').val(), this.id,'l_t_order_id')" required>
                                    <div class="input-group-append">
