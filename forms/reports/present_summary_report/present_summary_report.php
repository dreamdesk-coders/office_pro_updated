...
?>
    <script type="text/javascript" src="assets/js/reports/present_summary_report/present_summary_report.js"></script>
                ...
                <div class="col-md-6">
                    <div class="row bg-white report">
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_f_present_id">From Present ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_present_id" name="f_present_id" onchange="check_data_exist('present','present_id',$('#f_present_id').val(), this.id,'l_f_present_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_present_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_t_present_id">To Present ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_present_id" name="t_present_id" onchange="check_data_exist('present','present_id',$('#t_present_id').val(), this.id,'l_t_present_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_present_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
