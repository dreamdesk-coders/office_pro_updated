...
?>
    <script type="text/javascript" src="assets/js/reports/customer_credit_report/customer_credit_report.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row bg-white report report-left">
                        ...
                        <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="ttradio" value="sale" id="tt_all" checked>All
                                </label>
                            </div><br>
                            <div class="form-check">
                                <label class="form-check-label">
