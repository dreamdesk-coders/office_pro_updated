...
?>
    <script type="text/javascript" src="assets/js/reports/daily_expense_report/daily_expense_report.js"></script>
                    ...
                    <div class="row bg-white report">
                        ...
                        <div class="col-md-6">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_expense_id" name="f_expense_id" onchange="check_data_exist('expenses','expense_id',$('#f_expense_id').val(), this.id,'l_f_expense_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_expense_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_expense_id" name="t_expense_id" onchange="check_data_exist('expenses','expense_id',$('#t_expense_id').val(), this.id,'l_t_expense_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_expense_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" value="date" id="gb_date" checked>Date
                                </label>
                            </div><br>
                        </div>
                    </div>
