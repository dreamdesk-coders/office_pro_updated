...
?>
    <script type="text/javascript" src="assets/js/reports/purchase_order_cancel_summary_report/purchase_order_cancel_summary_report.js"></script>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row bg-white report">
                        <div class="col-md-12">
                            <h4>Purchase Order Cancel Summary Report</h4>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form>
                        ...
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_f_order_id">From Order ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_order_id" name="f_order_id" onchange="check_data_exist('purchase_order','order_id',$('#f_order_id').val(), this.id,'l_f_order_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_order_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 ft_invoice">
                            <form>
                                <label for="l_t_order_id">To Order ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_order_id" name="t_order_id" onchange="check_data_exist('purchase_order','order_id',$('#t_order_id').val(), this.id,'l_t_order_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_order_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>

                        <div class="col-md-6 ft_supplier">
                            <form>
                                <label for="l_f_supplier_id">From Supplier ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="f_supplier_id" name="f_supplier_id" onchange="check_data_exist('supplier','supplier_id',$('#f_supplier_id').val(), this.id,'l_f_supplier_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_f_supplier_id"></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-6 ft_stock">
                            <form>
                                <label for="l_t_supplier_id">To Supplier ID</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="t_supplier_id" name="t_supplier_id" onchange="check_data_exist('supplier','supplier_id',$('#t_supplier_id').val(), this.id,'l_t_supplier_id')" required>
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary lookup-btn" type="button" id="btn_t_supplier_id"></button>
                                    </div>
                                </div>
                            </form>
                            </form>
                ...
                <div class="col-md-6">
                    <div class="row bg-white report report-left">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optradio" value="supplier" id="gb_supplier">Supplier ID
                                </label>
                            </div>
