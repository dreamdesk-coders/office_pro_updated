...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('purchase_order_cancel_summary_report')">Excel Export</button>
    </div>

    <table id="purchase_order_cancel_summary_report" class="voucher">
        <tr>
            <td>
                <div class="heading">
                ...
                <br>
                <h5 class="title">Purchase Order Cancel Summary Report</h5>
                <hr><br>

                <?php


                $sql3 = "Select cancel_date,$group_by,sum(total_amount) as grand_total_amount From purchase_order where cancel_date between :f_date and :t_date and order_id between :f_order_id and :t_order_id and supplier_id between :f_supplier_id and :t_supplier_id and currency_id between :f_currency_id and :t_currency_id and staff_id between :f_staff_id and :t_staff_id and office_id between :f_office_id and :t_office_id and status = 'inactive' group by cancel_date,$group_by order by cancel_date asc";
