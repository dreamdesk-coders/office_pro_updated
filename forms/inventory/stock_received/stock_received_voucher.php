...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('stock_received')">Excel Export</button>
    </div>

    <table id="stock_received" class="voucher">
        <!-- Start Header -->
        <thead>
            <tr>
                <td>
                    ...
                    <br>
                    <h5 class="title">Stock Received Voucher</h5>
                    <hr><br>
                    <!-- <br><br><br> -->
                        ...
                        <div class="col-sm-6 head-data">
                            <table class="top-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="data"> : <?php $date = date_create($received_date);
