...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "Select * From stock_received WHERE received_id=:received_id";
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="handler/inventory/stock_received/stock_received_handler.php" class="frm_">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="received_id">Receive ID</label>
                                    <input type="text" class="form-control" id="received_id" name="received_id" value="<?php echo htmlentities($received_id); ?>" readonly required>
                                </div>

                                <div class="form-group">
                                    <label for="received_date">Date</label>
                                    <input type="date" class="form-control" id="received_date" name="received_date" value="<?php echo htmlentities($received_date); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="res-table">
                                    <table class="table table-striped" id="_table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "Select * From stock_received_details where received_id=:received_id ";
                                            $query = $dbh->prepare($sql);
                                            $query->bindParam(':received_id', $received_id, PDO::PARAM_STR);
                                            $query->execute();
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="receive_type" id="normal" value="normal" <?php if ($receive_type == "normal") {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>>
                                    <label class="form-check-label" for="normal">Normal</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="receive_type" id="marketing" value="marketing" <?php if ($receive_type == "marketing") {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>>
                        ...
                        <input type="submit" name="update" value="Update Stock Receive" class="btn btn-primary">
                        <input type="button" value="Cancel" onclick="window.location.href ='<?php echo $common_form_route . "?frm=stock_received_list" ?>'" class="btn btn-secondary">

                        <a href="handler/inventory/stock_received/stock_received_handler.php?delete=1&received_id=<?php echo $received_id ?>" class="btn btn-danger">Delete Transaction</a>
                        <input type="button" value="List" onclick="window.location.href ='<?php echo $common_form_route . "?frm=stock_received_list" ?>'" class="btn btn-info">
                    </form>
                </div>
            </div>
        </div>
