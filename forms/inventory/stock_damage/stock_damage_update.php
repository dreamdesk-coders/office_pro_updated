...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="handler/inventory/stock_damage/stock_damage_handler.php" class="frm_"> 
                    <h4>Stock Damage</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                            <label for="damage_id">Damage ID</label>
                            <input type="text" class="form-control" id="damage_id" name="damage_id" value="<?php echo htmlentities($damage_id);?>" readonly  required>
                            </div>

                            <div class="form-group">
                            <label for="damage_date">Date</label>
                            <input type="date" class="form-control" id="damage_date" name="damage_date" value="<?php echo htmlentities($damage_date);?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                     ...
                     <input type="submit" name="update" value="Update Stock Damage" class="btn btn-primary">
                     <input type="button" value="Cancel" onclick="window.location.href ='<?php echo $common_form_route."?frm=stock_damage_list" ?>'" class="btn btn-secondary">
                     
                     <a href="handler/inventory/stock_damage/stock_damage_handler.php?delete=1&damage_id=<?php echo $damage_id ?>" class="btn btn-danger">Delete Transaction</a>
                    <input type="button" value="List" onclick="window.location.href ='<?php echo $common_form_route."?frm=stock_damage_list" ?>'" class="btn btn-info">
                </form>
            </div>
        </div>
    </div>
