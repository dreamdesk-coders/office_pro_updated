                ...
                <form method="POST" action="handler/inventory/stock_damage/stock_damage_handler.php" class="frm_"> 
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <label for="invoice_id">Damage ID</label>
                            <input type="text" class="form-control" id="damage_id" name="damage_id" onchange="check_id_exist('stock_damage','damage_id',this.id)" required>
                            </div>
                     ...
                     <input type="submit" name="save" value="Add Stock Damage" onclick="sum_amounts()" class="btn btn-primary">
