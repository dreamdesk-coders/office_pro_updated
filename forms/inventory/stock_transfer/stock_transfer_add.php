                ...
                <form method="POST" action="handler/inventory/stock_transfer/stock_transfer_handler.php" class="frm_"> 
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <label for="invoice_id">Transfer ID</label>
                            <input type="text" class="form-control" id="transfer_id" name="transfer_id" onchange="check_id_exist('stock_transfer','transfer_id',this.id)" required>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="to_office_id" name="to_office_id" onchange="check_data_exist('office','office_id',$('#to_office_id').val(), this.id,'lbl_to_office_id')" required>
                                <div class="input-group-append">
                     ...
                     <input type="submit" name="save" value="Add Stock Transfer" onclick="sum_amounts()" class="btn btn-primary">
