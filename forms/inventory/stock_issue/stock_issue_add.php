            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="handler/inventory/stock_issue/stock_issue_handler.php" class="frm_">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="issue_id" name="issue_id" onchange="check_id_exist('stock_issue','issue_id',this.id)" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="issue_type" id="normal" value="normal" checked>
                                    <label class="form-check-label" for="normal">Normal</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="issue_type" id="marketing" value="marketing">
                        ...
                        <input type="submit" name="save" value="Add Stock Issue" onclick="sum_amounts()" class="btn btn-primary">
