...
?>
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="handler/inventory/stock_issue/stock_issue_handler.php" class="frm_">
                        <h4>Stock Issue</h4>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="issue_id">Issue ID</label>
                                    <input type="text" class="form-control" id="issue_id" name="issue_id" value="<?php echo htmlentities($issue_id); ?>" readonly required>
                                </div>

                                <div class="form-group">
                                    <label for="issue_date">Date</label>
                                    <input type="date" class="form-control" id="issue_date" name="issue_date" value="<?php echo htmlentities($issue_date); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="issue_type" id="normal" value="normal" <?php if($issue_type == "normal"){echo "checked";}?>>
                                    <label class="form-check-label" for="normal">Normal</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="issue_type" id="marketing" value="marketing" <?php if($issue_type == "marketing"){echo "checked";}?>>
                        ...
                        <input type="submit" name="update" value="Update Stock Issue" class="btn btn-primary">
                        <input type="button" value="Cancel" onclick="window.location.href ='<?php echo $common_form_route . "?frm=stock_issue_list" ?>'" class="btn btn-secondary">

                        <a href="handler/inventory/stock_issue/stock_issue_handler.php?delete=1&issue_id=<?php echo $issue_id ?>" class="btn btn-danger">Delete Transaction</a>
                        <input type="button" value="List" onclick="window.location.href ='<?php echo $common_form_route . "?frm=stock_issue_list" ?>'" class="btn btn-info">
                    </form>
                </div>
            </div>
        </div>
