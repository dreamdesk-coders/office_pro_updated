...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['id'])) {
        ...
        $sql = "Select * From present,customer WHERE present_id=:present_id and present.customer_id = customer.customer_id";
...
?>
    ...
    <div class="nav-bar no-print">
        ...
        <button id="exportExcel" class="btn btn-light" onclick="javascript:exportExcel('present')">Excel Export</button>
    </div>

    <table id="present" class="voucher">
        <!-- Start Header -->
        <thead>
            <tr>
                <td>
                    ...
                    <br>
                    <h5 class="title">Present Voucher</h5>
                    <hr><br>
                    <!-- <br><br><br> -->
