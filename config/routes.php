    ...
    switch ($frm) {
        ...
        case "not_activated":
            ...
            // Auth Section
        case "selection":
            include_once("forms/master/selection.php");
            break;
        case "login":
        ...
        case "purchase_return_voucher":
            ...
            break;
        case "opening_purchase_list":
            include_once("forms/purchase/opening/opening_purchase_list.php");
            break;
        case "opening_purchase_update":
            include_once("forms/purchase/opening/opening_purchase_update.php");
            break;
        ...
        case "so_sale_update":
            ...
            break;
        case "opening_sale_list":
            include_once("forms/sale/opening/opening_sale_list.php");
            break;
        case "opening_sale_update":
            include_once("forms/sale/opening/opening_sale_update.php");
            break;
        case "opening_delivery_list":
            include_once("forms/sale/opening/opening_delivery_list.php");
            break;
        case "opening_delivery_update":
            include_once("forms/sale/opening/opening_delivery_update.php");
            break;
