...
$(document).ready(function () {
    ...
    $("#btn_f_use_id").click(function () {
        get_lookup_data('office_use', 'use_id', 'use_date', 'use ID', 'use Date', 'f_use_id')
    });

    $("#btn_t_use_id").click(function () {
        get_lookup_data('office_use', 'use_id', 'use_date', 'use ID', 'use Date', 't_use_id')
    });
