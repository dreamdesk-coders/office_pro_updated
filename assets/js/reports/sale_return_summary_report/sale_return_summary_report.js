...
$(document).ready(function () {
    ...
    $("#btn_f_invoice_id").click(function () {
        get_lookup_data('sale_return', 'invoice_id', 'invoice_date', 'Invoice ID', 'Invoice Date', 'f_invoice_id')
    });

    $("#btn_t_invoice_id").click(function () {
        get_lookup_data('sale_return', 'invoice_id', 'invoice_date', 'Invoice ID', 'Invoice Date', 't_invoice_id')
    });
