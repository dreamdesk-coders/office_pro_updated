...
$(document).ready(function () {
    ...
    $("#btn_f_order_id").click(function () {
        get_lookup_data('delivery_order', 'order_id', 'order_date', 'Invoice ID', 'Invoice Date', 'f_order_id')
    });

    $("#btn_t_order_id").click(function () {
        get_lookup_data('delivery_order', 'order_id', 'order_date', 'Invoice ID', 'Invoice Date', 't_order_id')
    });
