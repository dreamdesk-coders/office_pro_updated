...
$(document).ready(function () {
    ...
    $("#btn_f_transfer_id").click(function () {
        get_lookup_data('stock_transfer', 'transfer_id', 'transfer_date', 'transfer ID', 'transfer Date', 'f_transfer_id')
    });

    $("#btn_t_transfer_id").click(function () {
        get_lookup_data('stock_transfer', 'transfer_id', 'transfer_date', 'transfer ID', 'transfer Date', 't_transfer_id')
    });
