...
$(document).ready(function () {
    ...
    $("#btn_f_damage_id").click(function () {
        get_lookup_data('stock_damage', 'damage_id', 'damage_date', 'damage ID', 'damage Date', 'f_damage_id')
    });

    $("#btn_t_damage_id").click(function () {
        get_lookup_data('stock_damage', 'damage_id', 'damage_date', 'damage ID', 'damage Date', 't_damage_id')
    });
...
function view_report() {
    window.open('?frm=damage_summary_report_view&f_date=' + $('#f_date').val() + '&t_date=' + $('#t_date').val() + '&f_damage_id=' + $('#f_damage_id').val() + '&t_damage_id=' + $('#t_damage_id').val() + '&f_currency_id=' + $('#f_currency_id').val() + '&t_currency_id=' + $('#t_currency_id').val() + '&f_staff_id=' + $('#f_staff_id').val() + '&t_staff_id=' + $('#t_staff_id').val() + '&f_office_id=' + $('#f_office_id').val() + '&t_office_id=' + $('#t_office_id').val() + '&group_by=' + group_by);
}
