...
$(document).ready(function () {
    ...
    $("#btn_f_present_id").click(function () {
        get_lookup_data('present', 'present_id', 'present_date', 'present ID', 'present Date', 'f_present_id')
    });

    $("#btn_t_present_id").click(function () {
        get_lookup_data('present', 'present_id', 'present_date', 'present ID', 'present Date', 't_present_id')
    });
...
function view_report() {
    window.open('?frm=present_summary_report_view&f_date=' + $('#f_date').val() + '&t_date=' + $('#t_date').val() + '&f_present_id=' + $('#f_present_id').val() + '&t_present_id=' + $('#t_present_id').val() + '&f_currency_id=' + $('#f_currency_id').val() + '&t_currency_id=' + $('#t_currency_id').val() + '&f_staff_id=' + $('#f_staff_id').val() + '&t_staff_id=' + $('#t_staff_id').val() + '&f_office_id=' + $('#f_office_id').val() + '&t_office_id=' + $('#t_office_id').val() + '&group_by=' + group_by);
}
