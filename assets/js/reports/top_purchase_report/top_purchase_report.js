...
function view_report() {
    window.open('?frm=top_purchase_report_view&f_date=' + $('#f_date').val() + '&t_date=' + $('#t_date').val() + '&f_currency_id=' + $('#f_currency_id').val() + '&t_currency_id=' + $('#t_currency_id').val() + '&f_office_id=' + $('#f_office_id').val() + '&t_office_id=' + $('#t_office_id').val() + '&purchase_type=' + purchase_type + '&limit=' + $('#range').val() + '&group_by=' + group_by);
}
