...
$(document).ready(function () {
    ...
    $("#btn_f_invoice_id").click(function () {
        get_lookup_data('purchase', 'invoice_id', 'invoice_date', 'Invoice ID', 'Invoice Date', 'f_invoice_id')
    });

    $("#btn_t_invoice_id").click(function () {
        get_lookup_data('purchase', 'invoice_id', 'invoice_date', 'Invoice ID', 'Invoice Date', 't_invoice_id')
    });
...
function view_report() {
    window.open('?frm=purchase_summary_report_view&f_date=' + $('#f_date').val() + '&t_date=' + $('#t_date').val() +  '&f_invoice_id=' + $('#f_invoice_id').val() + '&t_invoice_id=' + $('#t_invoice_id').val() +  '&f_supplier_id=' + $('#f_supplier_id').val() + '&t_supplier_id=' + $('#t_supplier_id').val() +  '&f_currency_id=' + $('#f_currency_id').val() + '&t_currency_id=' + $('#t_currency_id').val() +  '&f_staff_id=' + $('#f_staff_id').val() + '&t_staff_id=' + $('#t_staff_id').val() +'&f_office_id=' + $('#f_office_id').val() + '&t_office_id=' + $('#t_office_id').val() + '&purchase_type=' + purchase_type + '&group_by=' + group_by);
}
